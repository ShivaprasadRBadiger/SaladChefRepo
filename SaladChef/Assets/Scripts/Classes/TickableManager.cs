...
namespace SaladChef
{
	...
	public class TickableManager : MonoBehaviour, ITickableManager
	{
		...
		public static TickableManager _Instance;
		public static TickableManager Instance
		{
			get
			{
				if (_Instance == null)
				{
					_Instance = new GameObject("GameManager", typeof(TickableManager)).GetComponent<TickableManager>();
